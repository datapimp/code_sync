CodeSync.LocalStore = Backbone.Collection.extend
  initialize:(models=[],@options={})->
    _.extend(@, options)
    throw "LocalStore collections must specify a namespace property" unless @namespace?

    @localStorage = new CodeSync.LocalStorageAdapter(name: @namespace)
...
class CodeSync.LocalStorageAdapter
...
CodeSync.LocalStore::sync = (method, model, options)->
